...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web" '("org2web-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-config" '("org2web-get-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-devtools" '("org2web-devtools-repository-directory")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-el2org" '("org2web-el2org-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-export" '("org2web-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-resource" '("org2web-prepare-theme-resources")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-template" '("org2web-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-util" '("org2web-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-vars" '("org2web-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org2web-webserver" '("org2web-webserver-")))
