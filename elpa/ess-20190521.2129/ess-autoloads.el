...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-r-mode" '("R-" "ess-" "inferior-ess-" "run-ess-r-newest")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-stata-lang" '("STA-editing-alist" "ado-set-font-lock-keywords" "ess-" "stata-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-stata-mode" '("STA-" "Stata-mode" "ess-" "inferior-ess-stata-mode" "stata")))
