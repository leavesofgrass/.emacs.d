...
`ac-html-csswatcher+' automatically added to mode hook when you `ac-html-csswatcher-setup'." t nil)
...
when `csswatcher' support them." nil nil)

(defalias 'company-web-csswatcher-setup 'ac-html-csswatcher-setup)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ac-html-csswatcher" '("AC-HTML-CSSWATCHER-LOG" "ac-html-csswatcher-")))
