;;; nerdtab-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Nerdtab mode' mode.  If the prefix argument is positive, enable
...
evaluate `(default-value \\='nerdtab-mode)'.

The mode's hook is called both when the mode is enabled and when
it is disabled.

(fn &optional ARG)" t)
(register-definition-prefixes "nerdtab" '("define-nerdtab-" "nerdtab-"))

;;; End of scraped data

(provide 'nerdtab-autoloads)
