;;; rubocopfmt-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Format the current buffer with rubocop." t)
