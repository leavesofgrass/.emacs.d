...
Several children can be added, by using `org-brain-entry-separator'." t nil)

(autoload 'org-brain-add-child-headline "org-brain" "\
Create a new internal child headline to entry at point.
Several children can be created, by using `org-brain-entry-separator'." t nil)

(autoload 'org-brain-remove-child "org-brain" "\
Remove child from entry at point." t nil)
...
Several parents can be added, by using `org-brain-entry-separator'." t nil)

(autoload 'org-brain-remove-parent "org-brain" "\
Remove external parent from entry at point." t nil)
...
Several friends can be added, by using `org-brain-entry-separator'." t nil)
...
Run `org-brain-visualize' on a random org-brain entry." t nil)
