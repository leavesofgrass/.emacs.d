;;; ioccur-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`ioccur-buffer' is erased and a new search is started." t)
(autoload 'ioccur-quit "ioccur" "\
Quit `ioccur-buffer'." t)
(autoload 'ioccur-next-line "ioccur" "\
Goto next line if it is not an empty line." t)
(autoload 'ioccur-precedent-line "ioccur" "\
Goto precedent line if it is not an empty line." t)
(autoload 'ioccur-beginning-of-buffer "ioccur" "\
Goto beginning of `ioccur-buffer'." t)
(autoload 'ioccur-end-of-buffer "ioccur" "\
Go to end of `ioccur-buffer'." t)
(autoload 'ioccur-jump-and-quit "ioccur" "\
Jump to line in other buffer and quit search buffer." t)
...
Scroll down `ioccur-buffer' and `ioccur-current-buffer' simultaneously." t)
(autoload 'ioccur-scroll-up "ioccur" "\
Scroll up `ioccur-buffer' and `ioccur-current-buffer' simultaneously." t)
(autoload 'ioccur-split-window "ioccur" "\
Toggle split window, vertically or horizontally." t)
...
(register-definition-prefixes "ioccur" '("ioccur-"))

;;; End of scraped data
