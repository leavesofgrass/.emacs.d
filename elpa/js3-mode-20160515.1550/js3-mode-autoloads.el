...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "js3" '("char-is-" "deflocal" "js3" "lazy-detect" "neq" "with-buffer")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "js3-mode" '("char-is-" "deflocal" "js3" "lazy-detect" "neq" "with-buffer")))
